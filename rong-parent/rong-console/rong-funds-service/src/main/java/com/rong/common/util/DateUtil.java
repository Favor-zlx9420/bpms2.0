...
public class DateUtil {
    ...
    public static void main(String[] args) {
        String str = DateUtil.dateToDateString(new Date(), "yyyyMMddHHmmss");
        System.out.println("输出当前交易时间：" + str);
//        String date = DateUtil.dateToDateString(new Date(),DateUtil.yyyyMMdd_EN);
//        String time = DateUtil.dateToDateString(new Date(),"HHmmss");
        String date = str.substring(0,8);
        String time = str.substring(8,14);
